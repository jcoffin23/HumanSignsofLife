...
function [rxSig,tgtPlat,rxPlat,txPlat] = PDRmonostaticChirp(targets,transmitter,receiver,txchannel,rxchannel,radiator,collector,beamformer,tgtPlat,rxPlat,txPlat,dt,refSig,numTgt,tgtStruct)

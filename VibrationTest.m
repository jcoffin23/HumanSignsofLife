...
tgtStruct.human = [0,1,1,1,1];
% tgtStruct.human = [0,0,0,0,0];
tgtStruct.offset = [10,15,20,25,30];
...
inputStruct.enableVibration = 0;
inputStruct.vibration = [5,10,40;
                         amp1,amp2,amp3]; %Vibrations at 20, 40, and 1500 

                     

                     
[frError,fhError,rangeRes,chestSig,peakFFT,tgtStructOut,recvPow] = singleMCTrial_Vibration(inputStruct,tgtStruct);

...
function [rxSig,tgtPlat,rxPlat,txPlat] = monostaticChirp(targets,transmitter,receiver,txchannel,rxchannel,radiator,collector,beamformer,tgtPlat,rxPlat,txPlat,dt,waveform,numTgt)
